...
static const PROGMEM u1_t NWKSKEY[16] = { 0x77, 0x6F, 0x46, 0x22, 0x70, 0xB2, 0xC9, 0xF5, 0xFD, 0xDF, 0xF8, 0x5E, 0xBB, 0x25, 0xDD, 0xEB };


// LoRaWAN AppSKey, application session key
static const u1_t PROGMEM APPSKEY[16] = { 0xAC, 0x92, 0x70, 0x4C, 0xE9, 0x12, 0xA9, 0x24, 0xEA, 0xA0, 0x92, 0x5F, 0x8D, 0xD3, 0x86, 0xC3 };

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
// The library converts the address to network byte order as needed.
#ifndef COMPILE_REGRESSION_TEST
static const u4_t DEVADDR = 0x26011A6F;
#else
...
const lmic_pinmap lmic_pins = {
  ...
  .rst = 14,
  //.dio = {26, 35, 33},           // LBT cal for the Adafruit Feather M0 LoRa, in dB
   .dio = {26, 33, 32}
};
...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        Serial.print("humidité: ");Serial.print(rHumidity);
        Serial.println("% ");
        // adjust for the f2sflt16 range (-1 to 1)
